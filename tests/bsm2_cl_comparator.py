...
def compare_bsm2_cl():
    ...
    print("-----Simulating with timestep 1/60/24-----")
    ...
    print("-----Simulating with timestep 2/60/24-----")
    ...
    print("-----Simulating with timestep 3/60/24-----")
    ...
    (line1, ) = plt.plot(bsm2_cl_1.simtime, kla3_list1, label='1/60/24', color='blue', linestyle='-')
    (line2, ) = plt.plot(bsm2_cl_2.simtime, kla3_list2, label='2/60/24', color='orange', linestyle='--')
    (line3, ) = plt.plot(bsm2_cl_3.simtime, kla3_list3, label='3/60/24', color='green', linestyle='-.')
    plt.legend()
    plt.grid()
    plt.show()
