...
reactor3 = asm1.ASM1reactor(aerationvalues3[0], asm1init.VOL3, yinit3, asm1init.PAR3, asm1init.carb3, asm1init.carbonsourceconc, TEMPMODEL, ACTIVATE, DECAY)
reactor4 = asm1.ASM1reactor(aerationvalues4[0], asm1init.VOL4, yinit4, asm1init.PAR4, asm1init.carb4, asm1init.carbonsourceconc, TEMPMODEL, ACTIVATE, DECAY)
reactor5 = asm1.ASM1reactor(aerationvalues5[0], asm1init.VOL5, yinit5, asm1init.PAR5, asm1init.carb5, asm1init.carbonsourceconc, TEMPMODEL, ACTIVATE, DECAY)
...
aerationcontrol3 = aerationcontrol.PIaeration(aerationcontrolinit.KLa3_max, aerationcontrolinit.KSO3, aerationcontrolinit.TiSO3, aerationcontrolinit.TtSO3, aerationcontrolinit.SO3ref, aerationcontrolinit.KLa3offset, aerationvalues3[1], aerationvalues3[2], aerationvalues3[3], aerationvalues3[4])
...
aerationcontrol4 = aerationcontrol.PIaeration(aerationcontrolinit.KLa4_max, aerationcontrolinit.KSO4, aerationcontrolinit.TiSO4, aerationcontrolinit.TtSO4, aerationcontrolinit.SO4ref, aerationcontrolinit.KLa4offset, aerationvalues4[1], aerationvalues4[2], aerationvalues4[3], aerationvalues4[4])
...
aerationcontrol5 = aerationcontrol.PIaeration(aerationcontrolinit.KLa5_max, aerationcontrolinit.KSO5, aerationcontrolinit.TiSO5, aerationcontrolinit.TtSO5, aerationcontrolinit.SO5ref, aerationcontrolinit.KLa5offset, aerationvalues5[1], aerationvalues5[2], aerationvalues5[3], aerationvalues5[4])
...
# with open('asm1_kla_ps_flex_ohne.csv', 'w', newline='') as csvfile:
#     writer = csv.writer(csvfile, delimiter=' ')
#     writer.writerows(kla_flex)

kla = np.array([kla1in, kla2in, kla3in, kla4in, kla5in])
with open('ps4mit0undbed_kla.csv', 'w', newline='') as csvfile:
    writer = csv.writer(csvfile, delimiter=' ')
    writer.writerows(kla)

# Save data in csv-File:
with open('ps4mit0undbed_effav.csv', 'w', newline='') as csvfile:
    writer = csv.writer(csvfile, delimiter=' ')
    writer.writerow(ys_eff_av)

with open('ps4mit0undbed_eff.csv', 'w', newline='') as csvfile:
    writer = csv.writer(csvfile, delimiter=' ')
