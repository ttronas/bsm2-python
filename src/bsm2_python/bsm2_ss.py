...
# calculate totalN, COD and BOD5 from ys_of
totalN_eff, COD_eff, BOD5_eff = plantperformance.advanced_quantities(ys_of, ['totalN', 'COD', 'BOD5'])
...
data = [[ae], [pe], [me], SNH_violationvalues, TSS_violationvalues,
        totalN_violationvalues, COD_violationvalues, BOD5_violationvalues]
