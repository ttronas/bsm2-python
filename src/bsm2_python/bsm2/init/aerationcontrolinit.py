...
"""Time delay for artificial Q~w~ actuator (acts as first-order filter) [min]."""
...
KLA4_MIN = 0
"""Minimum value for PI controller 4 [d^-1^]."""
KLA4_MAX = 360
"""Maximum value for PI controller 4 [d^-1^]."""
...
"""Integral part time constant for PI controller 4 [d]."""
TTSO4 = 0.001  # Antiwindup time constant (d), tracking time constant, 0.0002 in BSM1 book
"""Antiwindup time constant for PI controller 4 [d]."""
SO4INTSTATE = -321.7493546935257
"""Integral saturated oxygen concentration of PI controller 4 [g(O~2~) $\cdot$ m^-3^]."""
SO4AWSTATE = 379.05091041032915
"""Antiwindup saturated oxygen concentration of PI controller 4 [g(O~2~) $\cdot$ m^-3^]."""
SO4REF = 2  # setpoint for controller, mg (-COD)/l
"""Setpoint for controller 4 [g(O~2~) $\cdot$ m^-3^]."""
...
"""Integral part time constant for K~L~a actuator 4 [min]."""
...
"""Integral part time constant for K~L~a actuator 5 [min]."""
