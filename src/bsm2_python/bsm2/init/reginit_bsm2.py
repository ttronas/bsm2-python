...
"""Flow rate threshold for bypassing (type 2 splitter). Everything above this value is bypassed for primary clarifier [m^3^ $\cdot$ d^-1^]."""
QBYPASSPLANT = 1  # type 1, all of this is also bypassed the AS system
"""If 1, all of the influent also bypasses the AS system."""
QBYPASSAS = 0  # type 1, none of primary effluent bypassed for AS
"""If 1, none of the primary clarifier effluent bypasses the AS system."""
QTHICKENER2AS = 0  # type 1, none of thickener effluent to AS, all to primary
"""If 1, none of the thickener effluent goes to the AS system, all goes to the primary clarifier."""
QSTORAGE2AS = 0  # type 1, none of storage tank effluent to AS, all to primary
"""If 1, none of the storage tank effluent goes to the AS system, all goes to the primary clarifier."""
